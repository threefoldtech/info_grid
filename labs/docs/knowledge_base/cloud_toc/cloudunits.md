...
See how we compare with the market compute prices [here](./pricing_toc/pricing_toc.md).
...
See how we compare with market storage prices [here](./pricing_toc/pricing_toc.md).
