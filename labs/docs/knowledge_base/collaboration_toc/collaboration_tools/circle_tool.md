...
You would need to install and create an account on the [TF Connect App](../../../documentation/threefold_token/storing_tft/tf_connect_app) before being able to register and use the Circle Tool.
