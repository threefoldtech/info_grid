...
- `gpus` is an optional parameter a list of gpu ids specifies which gpus needed to be attached to this vm, these gpu ids can be retrieved from the [dashboard](https://dashboard.grid.tf)
