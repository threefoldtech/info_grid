...
If one disk of the QSFS array goes offline, the rest of the system can still function at 100%. Read more on this here, whereas if someone only stores information on one 3Node and this 3Node has a drastic disk failure, the user will lose the data. 
