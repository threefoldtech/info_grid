...
- [System Administrators](system_administrators/system_administrators.md)
  ...
  - [Dashboard](playground/home.md)
    ...
    - [Dashboard](playground/dashboard/dashboard.md)
      ...
      - [Bridge](playground/dashboard/bridge.md)
      - [Transfer](playground/dashboard/transfer.md)
      - [Farms](playground/dashboard/farms.md)
      - [Dedicated Nodes](playground/dashboard/dedicated_nodes.md)
    ...
    - [Solutions](playground/solutions/solutions.md)
      - [Basic Environments](playground/solutions/basic_environments_readme.md)
        - [Virtual Machines](playground/solutions/vm_intro.md)
          - [Micro and Full VM Differences](playground/solutions/vm_differences.md)
          - [Full Virtual Machine](playground/solutions/fullVm.md)
          - [Micro Virtual Machine](playground/solutions/vm.md)
        - [Kubernetes](playground/solutions/k8s.md)
        - [Nixos MicroVM](playground/solutions/nixos_micro.md)
        - [Add a Domain](playground/solutions/add_domain.md)
      - [Ready Community Solutions](playground/solutions/ready_community_readme.md)
        - [Algorand](playground/solutions/algorand.md)
        - [CapRover](playground/solutions/caprover.md)
          - [CapRover Admin](./playground/solutions/caprover_admin.md)
          - [CapRover Worker](./playground/solutions/caprover_worker.md)
        - [CasperLabs](playground/solutions/casper.md)
        - [Discourse](playground/solutions/discourse.md)
        - [Funkwhale](playground/solutions/funkwhale.md)
        - [Mattermost](playground/solutions/mattermost.md)
        - [Node Pilot](playground/solutions/nodepilot.md)
        - [Owncloud](playground/solutions/owncloud.md)
        - [Nextcloud](playground/solutions/nextcloud.md)
        - [Peertube](playground/solutions/peertube.md)
        - [Presearch](playground/solutions/presearch.md)
        - [Subsquid](playground/solutions/subsquid.md)
        - [Taiga](playground/solutions/taiga.md)
        - [WordPress](playground/solutions/wordpress.md)
        - [Umbrel](playground/solutions/umbrel.md)
